...
NODE_CMD=(node --experimental-config-file="${DIR}/node.config.json" --experimental-loader="${DIR}/bootstrap/ts-resolver.js" --import "file://${DIR}/bootstrap/node-suppress-warning.js")
